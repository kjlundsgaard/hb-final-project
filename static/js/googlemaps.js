...
function initMap() {
  ...
  // trying to create else statement just in case there are no restaurants in list and want to give default lat/long
  var centerLatLng = {lat: $(places[0]).data('lat'), lng: $(places[0]).data('lng')};
  ...
  // var styles = [{"stylers":[{"visibility":"simplified"},{"saturation":20},{"weight":3.2},{"lightness":25}]}];
